...
{
    /// <summary>
    /// NotifyingObject - Used to facilitate the use of System.ComponentModel.DataAnnotations for field validation
    /// </summary>
    /// <see cref="http://blogs.microsoft.co.il/blogs/tomershamam/archive/2010/10/28/wpf-data-validation-using-net-data-annotations-part-ii.aspx"/>
    public abstract class NotifyingObject : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        protected virtual string OnValidate(string propertyName)
        {
            ...
            if (!result)
            {
                var validationResult = results.Select(r => r.ErrorMessage).ToArray();
